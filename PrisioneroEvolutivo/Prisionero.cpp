...
*/
Prisionero::Prisionero(int numeroJugadores, int numMaximoEstados, int retardoPagoIN, double repartoPagoIN, double interesIN)
{
	...
	*/
	...
	{
		Jugador* tmp = new Jugador(numMaximoEstados, retardoPago, interes);
		tmp->iniciarJugador();
